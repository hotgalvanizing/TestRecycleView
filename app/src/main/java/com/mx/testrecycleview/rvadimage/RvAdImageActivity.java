package com.mx.testrecycleview.rvadimage;
...
public class RvAdImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rv_ad_image);
        ...
        mRecyclerView.setAdapter(new CommonAdapter<String>(RvAdImageActivity.this, R.layout.item, mockDatas) {
            @Override
