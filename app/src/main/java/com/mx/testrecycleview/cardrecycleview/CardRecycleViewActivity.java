...
public class CardRecycleViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_recycle_view);
    ...
    class Adapter extends RecyclerView.Adapter<Adapter.Holder> {
        ...
        public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
            View item = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_card_recycle_view, parent, false);
...
//            holder.item.setText("" + position);
            ...
            holder.item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(CardRecycleViewActivity.this, holder.text.getText(), Toast.LENGTH_SHORT).show();
                }
            });
        }
